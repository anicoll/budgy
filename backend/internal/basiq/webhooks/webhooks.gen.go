...
type WebhookStats struct {
	// ApplicationId unique identifier in the form of uuid for the application.
	ApplicationId *openapi_types.UUID `json:"applicationId,omitempty"`

	// Fail Number of failed message deliveries.
	Fail *int `json:"fail,omitempty"`

	// Pending Number of messages pending delivery.
	Pending *int `json:"pending,omitempty"`

	// Sending Number of messages currently being sent.
	...
	// WebhookId unique identifier in the form of uuid for the webhook.
...
type ClientInterface interface {
	...
	// GetWebhookStats request
	GetWebhookStats(ctx context.Context, webhookId string, reqEditors ...RequestEditorFn) (*http.Response, error)
}
...
func (c *Client) GetWebhookStats(ctx context.Context, webhookId string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetWebhookStatsRequest(c.Server, webhookId)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewGetWebhookStatsRequest generates requests for GetWebhookStats
func NewGetWebhookStatsRequest(server string, webhookId string) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/notifications/webhooks/%s/stats", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// GetWebhookStatsWithResponse request
	GetWebhookStatsWithResponse(ctx context.Context, webhookId string, reqEditors ...RequestEditorFn) (*GetWebhookStatsResponse, error)
}
...
type AddWebhookResponse struct {
	...
	JSON201      *struct {
		...
		Status AddWebhook201Status `json:"status"`
		Type   *string             `json:"type,omitempty"`
...
type AddWebhook201Status string
...
type GetWebhookResponse struct {
	...
	JSON200      *struct {
		...
		// Status status of the webhook.
		Status GetWebhook200Status `json:"status"`
		Type   *string             `json:"type,omitempty"`
...
type GetWebhook200Status string
...
type UpdateWebhookResponse struct {
	...
	JSON200      *struct {
		...
		// Status status of the webhook.
		Status UpdateWebhook200Status `json:"status"`
		Type   *string                `json:"type,omitempty"`
...
type UpdateWebhook200Status string
...
// Status returns HTTPResponse.Status
func (r GetWebhookStatsResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetWebhookStatsResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// GetWebhookStatsWithResponse request returning *GetWebhookStatsResponse
func (c *ClientWithResponses) GetWebhookStatsWithResponse(ctx context.Context, webhookId string, reqEditors ...RequestEditorFn) (*GetWebhookStatsResponse, error) {
	rsp, err := c.GetWebhookStats(ctx, webhookId, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetWebhookStatsResponse(rsp)
}
...
// ParseGetWebhookStatsResponse parses an HTTP response from a GetWebhookStatsWithResponse call
func ParseGetWebhookStatsResponse(rsp *http.Response) (*GetWebhookStatsResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &GetWebhookStatsResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
