  ...
  const budgets = [
    {
      ...
      targets: [
        ...
        { categoryId: catId("Utilities"), amount: 25000, frequency: "monthly", rollover: false },
        { categoryId: catId("Subscriptions"), amount: 5000, frequency: "monthly", rollover: false },
        { categoryId: catId("Insurance"), amount: 35000, frequency: "monthly", rollover: false },
        { categoryId: catId("Health"), amount: 10000, frequency: "monthly", rollover: true },
        { categoryId: catId("Clothing"), amount: 20000, frequency: "monthly", rollover: true },
